(function () {
    ...
    var rejects = [];
    var version = 'v3.6.1';
    var baseURL = 'https://trufi.github.io/static/mapsapi';
    var query = {};
    ...
    function requestJS() {
        ...
        script.setAttribute('src', baseURL + '/script.full.js');
    ...
    function loadStylesheet() {
        var url = baseURL + '/styles.full.dark.css';
            ...
            DG.ajax(url, {
                ...
                success: function (data) {
                    ...
                    if (baseURL !== originalBaseUrl) {
                        data = data.replace(new RegExp(originalBaseUrl, 'g'), baseURL);
                    }
    ...
    function prepareForInit() {
        return Promise.all([loadStylesheet(), loadProjectList(), ensureDOMReady()]);
    }
